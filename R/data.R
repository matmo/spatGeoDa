...
"airbnb" #' Atlanta Homicides 1980s-90s
#'
...
"atlanta" #' 2008 Cincinnati Crime + Socio-Demographics
#'
...
"cincinnati" #' Cleveland Home Sales (2015)
#'
...
"cleveland" #' 2012 and 2016 Presidential Elections
#'
...
"election" #' 2000 Health, Income + Diversity
#'
...
"health_diversity" #' Chicago Health Indicators (2005-11)
#'
...
"health_indicators" #' US county homicides 1960-1990
#'
...
"ncovr" #' Health, poverty and education indicators for Nepal districts
#'
...
"nepal" #' Rental Housing and Demographics in NYC (2000s)
#'
...
"nyc" #' Block-level Earnings in NYC (2002-14)
#'
...
"nyc_earnings" #' NYC Education (2000)
#'
...
"nyc_educ" #' Demographics for New York City neighborhoods
#'
...
"nyc_nhood" #' Police expenditures Mississippi counties
#'
